...
docToString DNull acc _ _ = acc ++ "null" ++ "\n"

docToString (DInteger x) acc _ _ = acc ++ show x ++ "\n"

docToString (DString x) acc _ _ = acc ++ show x ++ "\n"
